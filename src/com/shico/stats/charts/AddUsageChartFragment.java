...
public class AddUsageChartFragment extends ChartFragment {	
	private static final String EVENT_TYPE = "adAdtion";	
	...
	protected GraphicalView createChartView(List<List<String>> dataRows) {
		...
		case FIRST_PAGE_WITH_GROUPED_COLUMN_CHART:
			return ChartUtil.createGroupedBarChartViewForChannels(getActivity(), dataRows, 
					...
					new ChartTitles("", 
							getString(R.string.addUsage_y_title),
							getString(R.string.addUsage_title)+"\n"+titleBuilder.toString()));
	...
	protected String getChartTitle() {
		return getString(R.string.addUsage_title);
	}

	@Override
	public String[] getCellDisplayStrings() {
		return new String[]{"", getString(R.string.addUsage_cell_disp)};
	} 
