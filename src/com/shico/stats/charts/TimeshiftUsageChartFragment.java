...
public class TimeshiftUsageChartFragment extends ChartFragment {	
	private static final String EVENT_TYPE = "TIMESHIFTUsage";
	...
	protected GraphicalView createChartView(List<List<String>> dataRows) {
		...
		case FIRST_PAGE_WITH_COLUMN_CHART_VIEWERS:
			return ChartUtil.createGroupedBarChartViewForChannels(getActivity(), dataRows, 
					...
					new ChartTitles("", getString(R.string.timeshift_y_title1), titleBuilder.toString()));
		case SECOND_PAGE_WITH_COLUMN_CHART_DURATION:
			return ChartUtil.createGroupedBarChartViewForChannels(getActivity(), dataRows, 
					ChartDataLoader.durationIdx, 
					new ChartTitles("", getString(R.string.timeshift_y_title2), titleBuilder.toString()));
	...
	protected String getChartTitle() {
		...
		case FIRST_PAGE_WITH_COLUMN_CHART_VIEWERS:
		case SECOND_PAGE_WITH_COLUMN_CHART_DURATION:
			return getString(R.string.timeshift_title_column_chart);
		case THIRD_PAGE_WITH_PIE_CHART_VIEWERS:
			return getString(R.string.timeshift_title_pie_chart1);
		case FOURTH_PAGE_WITH_PIE_CHART_DURATION:
			return getString(R.string.timeshift_title_pie_chart2);
		}
		return "";
	}  	
